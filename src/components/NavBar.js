            ...
            <section className="jumbotron text-center bg">
                <div className="container font-weight-bold">
                    <h1>{ props.loggedIn ? <><p className="font-weight-bold">Welcome to stadium tracker, {props.currentUser.attributes.name}!</p> </> : null }</h1>
                        <p className="text-warning bg-dark">Never forget all your great times at the game! Record the stadiums you went to with an image, as well as each and every time you visited them!</p>
                    <p>
